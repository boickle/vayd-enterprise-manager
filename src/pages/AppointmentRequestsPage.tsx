  ...
  return (
    <div>
      ...
      <p className="settings-muted" style={{ marginBottom: 16, maxWidth: 800 }}>
        Triage incoming appointment requests from the client portal. Use Book to open routing with
        client and visit details prefilled when available. After booking, link the appointment here
        or it will link automatically when you book from routing. Text clients directly from the
        request phone number — including new clients who are not in the system yet.
      </p>
