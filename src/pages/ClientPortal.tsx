...
export default function ClientPortal() {
  ...
  const [selectedPetForMedicalRecord, setSelectedPetForMedicalRecord] = useState<PetWithWellness | null>(null);
    ...
    <div className="cp-wrap" style={{ maxWidth: 1120, margin: '32px auto', padding: '0 16px', width: '100%' }}>
      ...
      {!loading && !error && (
        <>
                      ...
                      <div style={{ padding: 12 }}>
                        ...
                        {p.dbId && (
                          <div style={{ marginTop: 12, paddingTop: 12, borderTop: '1px solid #e5e7eb' }}>
                            <button
                              onClick={() => {
                                setSelectedPetForMedicalRecord(p);
          ...
          {showMedicalRecordModal && selectedPetForMedicalRecord && selectedPetForMedicalRecord.dbId && (
            <MedicalRecordModal
              patientId={selectedPetForMedicalRecord.dbId}
              petName={selectedPetForMedicalRecord.name}
              onClose={() => {
